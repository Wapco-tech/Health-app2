...
<head>  
    ...
    <title><?php echo $language === 'en' ? 'Workout  - Health App' : 'تمرین - اپلیکیشن سلامت'; ?></title>  
    ...
    <link href="src/styles/css/workout.css" rel="stylesheet"> <!-- Link to your custom CSS --> 
    <link href="src/styles/scss/workout.scss" rel="stylesheet"> <!-- Link to your custom SCSS --> 
    <!-- // -->
    <script src="src/js/workout.js"></script> 
    ...
    <style>  
        ...
        body {  
            text-align: <?php echo $language === 'fa' ? 'right' : 'left'; ?>; /* Align text based on language */  
...
<body>  
        ...
        <ul class="nav">  
            <li class="nav-item">  
                <a href="profile.php" class="nav-link">  
                    <img src="<?php echo 'src/styles/css/icons/icons/outline/user.svg'; ?>" alt="Profile Icon" width="24" height="24" class="icon-white">  
                    <?php echo $language === 'en' ? 'Profile' : 'پروفایل'; ?>  
                </a>  
            </li>  
            <li class="nav-item">  
                <a href="personal_data.php" class="nav-link">  
                    <img src="<?php echo 'src/styles/css/icons/icons/outline/id.svg'; ?>" alt="Personal Data Icon" width="24" height="24" class="icon-white">  
                    <?php echo $language === 'en' ? 'Personal Data' : 'اطلاعات شخصی'; ?>  
                </a>  
            </li>  
            <li class="nav-item">  
                <a href="settings.php" class="nav-link">  
                    <img src="<?php echo 'src/styles/css/icons/icons/outline/settings.svg'; ?>" alt="Settings Icon" width="24" height="24" class="icon-white">  
                    <?php echo $language === 'en' ? 'Settings' : 'تنظیمات'; ?>  
                </a>  
            </li>  
            <li class="nav-item">  
                <a href="support.php" class="nav-link">  
                    <img src="<?php echo 'src/styles/css/icons/icons/outline/phone-call.svg'; ?>" alt="Support Icon" width="24" height="24" class="icon-white">  
                    <?php echo $language === 'en' ? 'Support' : 'پشتیبانی'; ?>  
                </a>  
            </li>  
            <li class="nav-item">  
                <a href="about.php" class="nav-link">  
                    <img src="<?php echo 'src/styles/css/icons/icons/outline/users-group.svg'; ?>" alt="About Us Icon" width="24" height="24" class="icon-white">  
    ...
    <div class="bottom-menu">  
        <a href="home.php">  
            <img src="<?php echo 'src/styles/css/icons/icons/outline/home.svg'; ?>" alt="Diet Plan Icon" width="24" height="24">  
            <span><?php echo $language === 'en' ? 'Home' : 'خانه'; ?></span>  
        </a>  
        <a href="diet_plan.php">  
            <img src="<?php echo 'src/styles/css/icons/icons/outline/tools-kitchen-3.svg'; ?>" alt="Diet Plan Icon" width="24" height="24">  
            <span><?php echo $language === 'en' ? 'Nutrition' : 'تغذیه'; ?></span>  
        </a>  
        <a href="workout_plan.php">  
            <img src="<?php echo 'src/styles/css/icons/icons/outline/run.svg'; ?>" alt="Workout Plan Icon" width="24" height="24">  
            <span><?php echo $language === 'en' ? 'Workout' : 'تمرین'; ?></span>  
        </a>  
        <a href="progress.php">  
            <img src="<?php echo 'src/styles/css/icons/icons/outline/trending-up.svg'; ?>" alt="Progress Icon" width="24" height="24">  
